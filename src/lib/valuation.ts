...
- MECHANIKUS VÉGSŐ ÁR: a "Javasolt ár" KÖTELEZŐEN a korrigált nm-ár × hasznos alapterület (a lokációs prémiummal együtt), a legközelebbi 500 000 Ft-ra kerekítve. Ez PONTOSAN egyezzen meg a "Becsült piaci érték" szakasz fő számával, és essen bele az "Értéksáv"-ba. TILOS a számított érték alá csökkenteni "alku/értékesítési" indokkal, és TILOS fölé emelni — a végső ár mechanikusan a levezetésből jöjjön, ne szabad becslésből.
